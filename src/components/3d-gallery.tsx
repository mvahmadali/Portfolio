  ...
  return (
    <div className="relative w-full h-screen bg-transparent overflow-hidden">
      <div className="absolute inset-0 pointer-events-none z-20">
        ...
        <div
          className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-[#64FFDA] opacity-[0.03] rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-80 h-80 bg-[#64FFDA] opacity-[0.03] rounded-full blur-3xl animate-pulse"
